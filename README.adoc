...
* link:Visual Studio Code (GUI)[https://code.visualstudio.com/]
* link:Terraform (CLI)[https://www.terraform.io/]
* link:Git Client (CLI)[https://git-scm.com/book/en/v2/Getting-Started-Installing-Git]
* link:Github Command Line Extension (CLI)[https://cli.github.com/]
* link:Python 3 (CLI)[https://www.python.org/]
* link:PostgreSQL (CLI)[https://www.postgresql.org/]
* link:Nano Text Editor (CLI)[https://www.nano-editor.org/]
